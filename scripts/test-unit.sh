...
PYTHONDONTWRITEBYTECODE=1 python3 -m unittest tests/unit/test_sway_bridge.py tests/unit/test_desktop_entry_runner.py tests/unit/test_launcher_backend.py
